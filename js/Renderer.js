...
/** constants */
const DEBUG = true;
const STAND_URL = 'models/STEND.glb';
...
export class Renderer {
    ...
    initClickableObjects() {
        ...
        this.clickHelperMeshes[0].onClick = function () {
            $('#device-description').html('').load("device_docs/DC60/advantages.html");
            $('#device-name').text('DC-60');
            this.cameraFocusDevice(this.clickHelperMeshes[0], 0, 1, 0);
            $('#main-menu').fadeOut().fadeIn();
            $('#description-container').fadeOut('fast');
            $('.item').removeClass('active');
            $('#submission-form').fadeOut('fast');
        }.bind(this);

        this.clickHelperMeshes[1].onClick = function () {
            $('#device-description').html('').load("device_docs/DC80/advantages.html");
            $('#device-name').text('DC-80');
        ...
        this.clickHelperMeshes[2].onClick = function () {
            $('#device-description').html('').load("device_docs/Resona7/advantages.html");
            $('#device-name').text('Resona-7');
        ...
        this.clickHelperMeshes[3].onClick = function () {
            $('#device-description').html('').load("device_docs/TE7/advantages.html");
            $('#device-name').text('TE 7');
