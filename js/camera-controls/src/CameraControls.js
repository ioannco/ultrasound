...
import { PI_2, PI_HALF, FPS_60, } from './constants';
import { approxZero, approxEquals, roundToStep, infinityToMaxNumber, maxNumberToInfinity, } from './utils/math-utils';
...
export class CameraControls extends EventDispatcher {
    constructor(camera, domElement) {
        ...
        if (this._domElement) {
            ...
            const zoomInternal = (delta /* , x: number, y: number */) => {
